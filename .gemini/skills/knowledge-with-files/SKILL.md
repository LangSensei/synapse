...
description: Standardizes the distillation of task insights into a structured format for the Synapse Atlas.
---

# Knowledge with Files

This skill ensures every task culminates in a high-quality, parsable technical manual.

## Important: Where Files Go

- **Templates** are in this skill's `templates/` folder
- **Your knowledge file** MUST go in the **task-specific neuron directory**: `.gemini/neurons/{user}/{task_id}/knowledge.md`
