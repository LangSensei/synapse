...
- **The Options Pattern:** Agents MUST NOT ask open-ended questions. Every decision point, request for feedback, or checkpoint MUST be presented as a list of numbered selectable options (1, 2, 3...). If the neuron provides input that doesn't match an option, it should be treated as a custom entry.
